...
namespace Example
{
	public class PropertyModelJsonConvertor : JsonConverter
	{
		...
		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			...
			model.connector = item.GetValue(JsonHelper.PropertyName<PropertyModel>(nameof(PropertyModel.connector)), StringComparison.InvariantCultureIgnoreCase)?.Value<string>();
		...
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
		{
			...
			writer.WritePropertyName(JsonHelper.PropertyName<PropertyModel>(nameof(PropertyModel.connector)));
			writer.WriteValue(model.connector);
